 ...
 * @author Fernando
 */
public class visorColas extends javax.swing.JFrame {

    /**
     * Creates new form visorColas
     */
    public visorColas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Banco Cooperativa");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/cooperativa-logo-D779193787-seeklogo.com.gif"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(visorColas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new visorColas().setVisible(true);
            }
        });
    }
